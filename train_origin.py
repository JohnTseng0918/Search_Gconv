...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        tr_prec1, tr_prec5, loss, lr = \
            train(train_loader, model, criterion, optimizer, epoch, arch)

        ### Evaluate on validation set
        val_prec1, val_prec5 = validate(val_loader, model, criterion, arch)
    ...
    print(model)
    validate(val_loader, model, criterion, arch)
    torch.save(model.state_dict(), "condensenetsupernet.pth")
    return
